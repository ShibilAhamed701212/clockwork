...
def resolve_integration_output_map(
    ...
    *,
    ...
    target_map = {
        "agent": [integration_dir / INTEGRATION_FILENAMES["agent"]],
    }
...
class IDEContextGenerator:
    ...
    def generate_all(self) -> dict[str, Path]:
        ...
        generators = {
            "agent": self.generate_agent_context,
        }
    ...
    def generate_agent_context(
        ...
        layer_str = (
            ...
            if layers
            else "- (run `clockwork graph` to build)"
        )
...
"""
    ...
    def _summarize_rules(self, rules_text: str) -> str:
        ...
        lines = [
            l.strip() for l in rules_text.splitlines() if l.strip().startswith("- ")
        ]
        if not lines:
